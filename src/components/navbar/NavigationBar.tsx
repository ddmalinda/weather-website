...
export default function NavigationBar() {
  ...
  //hooks
  // const [loctaion,setLocation]=useState("colombo")

  // const hadleLocationValu=(value)=>{
  //   setLocation(value)
  // }

  return (
    <nav className="shadow-sm sticky top-0 left-0 z-50 bg-white">
      <div className='h-[80px] w-full flex items-center justify-between px-3 mx-auto container'>
      ...
      {/* <Searchbox value="" onChange={}  onSubmite={} /> */}
       </section>
